...
Future<List<CollectionRecordset>?> getPostCollection(int? userID) async {
  ...
  final List<CollectionRecordset>? rs =
      pcs.recordset!.isEmpty ? [] : pcs.recordset;
...
class PostCollectionService {
  ...
  factory PostCollectionService.fromJson(Map<String, dynamic> json) =>
      PostCollectionService(
        recordsets: json["recordsets"] == null
            ? null
            : List<List<CollectionRecordset>>.from(json["recordsets"].map((x) =>
                List<CollectionRecordset>.from(
                    x.map((x) => CollectionRecordset.fromJson(x))))),
        recordset: json["recordset"] == null
            ? null
            : List<CollectionRecordset>.from(
                json["recordset"].map((x) => CollectionRecordset.fromJson(x))),
...
class CollectionRecordset {
  ...
  factory CollectionRecordset.fromJson(Map<String, dynamic> json) =>
      CollectionRecordset(
